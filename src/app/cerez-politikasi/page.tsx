...
export const metadata: Metadata = {
  ...
  description: "RN Yazılım Çerez Politikası. Çerezlerin ne amaçla kullanıldığı ve nasıl yönetildiği hakkında bilgi edinin.",
  alternates: {
...
export default function CookiePolicyPage() {
  const data = legalTexts.cookiePolicy;
