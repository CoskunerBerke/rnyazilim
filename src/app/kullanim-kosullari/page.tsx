...
export const metadata: Metadata = {
  ...
  description: "RN Yazılım Kullanım Koşulları. Web sitemizi ve hizmetlerimizi kullanırken uyulması gereken kuralları öğrenin.",
  alternates: {
...
export default function TermsOfUsePage() {
  const data = legalTexts.termsOfUse;
